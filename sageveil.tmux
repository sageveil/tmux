...
main() {
    sageveil_bg="#101310"
    sageveil_fg="#A8AFA6"
    sageveil_muted_fg="#8A928B"
    sageveil_red="#9A6B6B"
    sageveil_dyellow="#A69966"
    sageveil_byellow="#C6B67E"
    sageveil_green="#959C70"
    sageveil_cyan="#7F9476"
    sageveil_magenta="#876f7f"
    sageveil_border="#4E504C"
    sageveil_blue="#8A8493"
    sageveil_bblue="#A39DAC"
    sageveil_bcyan="#9AAB90"
    sageveil_bmagenta="#947e8d"
    sageveil_bgreen="#9C9F7F"
    sageveil_bred="#B08585"
    sageveil_surface="#1C211E"
    sageveil_overlay="#212723"
    sageveil_highlight="#241d21"
    sageveil_dim="#6F7B6F"
