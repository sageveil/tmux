...
main() {
    ...
    sageveil_red="#9A6B6B"
    sageveil_dyellow="#AC9C66"
    sageveil_byellow="#C6B67E"
    sageveil_green="#7E9270"
    sageveil_cyan="#6F9476"
    sageveil_magenta="#A37F90"
    sageveil_border="#4E504C"
    sageveil_blue="#8A8294"
    sageveil_bblue="#A39DAC"
    sageveil_bcyan="#88AB90"
    sageveil_bmagenta="#BC9AAC"
    sageveil_bgreen="#95A888"
    sageveil_bred="#B08585"
    sageveil_surface="#1D2320"
    sageveil_overlay="#1F2624"
    sageveil_highlight="#33423A"
    sageveil_dim="#616560"
